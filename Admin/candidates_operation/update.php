...
include('../databases/users_db.php');
          ...
          $sql ="SELECT * FROM `candidates` where SN = $id";
...
if(isset($_POST['update'])){
          ...
          $sql = "UPDATE candidates  set SN = $sn,
           ...
           ,Position = '$user_position', Grade = '$user_grade' where SN = $id";
      ...
      try{
         mysqli_query($conn, $sql);  
           echo"<script> alert('User updated Successfully')</script>";
              ...
              echo"<script> alert('Could not Update user')</script>";
